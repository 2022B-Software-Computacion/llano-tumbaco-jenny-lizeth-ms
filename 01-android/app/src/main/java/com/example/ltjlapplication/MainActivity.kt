...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val botonListView = findViewById<Button>(R.id.btn_ciclo_vida)
        botonListView
            .setOnClickListener{
        ...
        val botonIntent = findViewById<Button>(R.id.btn_ir_intent)
        botonIntent
            .setOnClickListener{
    ...
    fun abrirActividadConParametros(
        ...
        intentExplicito.putExtra("entrenadorPrincipal", BEntrenador(1,"jorge","Paleta"))
